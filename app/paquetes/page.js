...
export default function PaquetesPage() {
  ...
  return <main className="catalog-page">
    <header className="catalog-hero">
      ...
      <div className="catalog-hero-copy"><p>Lavado a domicilio</p><h1>Tu auto, como debe verse.</h1><span>Agenda cuidado profesional directo en tu cochera.</span><div className="catalog-actions"><a href="https://wa.me/524421549668" target="_blank" rel="noopener noreferrer" className="catalog-primary"><WhatsappLogo size={20} weight="fill" /> Cotizar por WhatsApp</a><button type="button" onClick={() => router.push('/')} className="catalog-secondary"><SealCheck size={20} weight="bold" /> Ver mis sellos</button></div></div>
    ...
    <section className="work-gallery"><div className="catalog-intro"><p>Hecho a domicilio</p><h2>Productos profesionales. Atención al detalle.</h2></div><div className="work-grid"><figure><Image src="/images/espuma.jpg" alt="Espuma activa aplicada a una camioneta" fill sizes="(max-width: 680px) 70vw, 420px" /><figcaption>Espuma activa sin contacto</figcaption></figure><figure><Image src="/images/productos.jpg" alt="Productos de limpieza automotriz profesional" fill sizes="(max-width: 680px) 55vw, 320px" /><figcaption>Químicos especializados</figcaption></figure></div></section>
